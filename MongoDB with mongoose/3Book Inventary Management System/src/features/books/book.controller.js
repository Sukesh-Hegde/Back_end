...
export default class BookController {
  ...
  listBooksByGenre = async (req, res) => {
    ...
    const updatedGenre = await this.bookRepository.listBooksByGenre(genre);
  ...
  updateBookAvailability = async (req, res) => {
    ...
    const updatedQuantity = await this.bookRepository.updateBookAvailability(bookId,quantity);
